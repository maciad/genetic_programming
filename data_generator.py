...
def generate_data(n_variables , n_rand , min_rand, max_rand, n_fit_cases, min_range, max_range, func):
    ...
    with open(filename, 'w') as f:
        ...
        if n_variables == 1:
            ...
            x = np.linspace(min_range, max_range, int(np.sqrt(n_fit_cases)))
            for x_ in x:
                y = np.linspace(min_range, max_range, int(np.sqrt(n_fit_cases)))
                for y_ in y:
                    f.write(f'{x_} {y_} ')
                    f_x = func(x_, y_)
                    f.write(f'{f_x}\n')
...
generate_data(2, 100, -5, 5, 400, 0, 1, func4)
generate_data(2, 100, -5, 5, 400, -10, 10, func4)
generate_data(2, 100, -5, 5, 400, 0, 100, func4)
generate_data(2, 100, -5, 5, 400, -1000, 1000, func4)

# [-3.14, 3.14], [0, 7], [0, 100], [-100, 100]
generate_data(2, 100, -5, 5, 400, -3.14, 3.14, func5)
generate_data(2, 100, -5, 5, 400, 0, 7, func5)
generate_data(2, 100, -5, 5, 400, 0, 100, func5)
generate_data(2, 100, -5, 5, 400, -100, 100, func5)

# [-10, 10], [0, 100], [-1, 1], [-1000, 1000]
generate_data(2, 100, -5, 5, 400, -10, 10, func6)
generate_data(2, 100, -5, 5, 400, 0, 100, func6)
generate_data(2, 100, -5, 5, 400, -1, 1, func6)
generate_data(2, 100, -5, 5, 400, -1000, 1000, func6)